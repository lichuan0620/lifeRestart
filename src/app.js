...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                人生开挂模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">这炫酷人生我想一直浪下去</div>
            </div>
        ...
        <div id="main">
            ...
            <button class="sponsor" onclick="window.open('https://github.com/VickScarlet/lifeRestart')" style="background: linear-gradient(90deg,#946ce6,#7e5fd9); left:auto; right:50%; transform: translate(-2rem,-50%);">原作者</button>
        </div>
        `);
        ...
        <div id="main">
            ...
            <button id="random" class="mainbtn" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);"">99连抽！</button>
            <ul id="talents" class="selectlist"></ul>
            <button id="next" class="mainbtn">请选择10个</button>
        </div>
        `);
